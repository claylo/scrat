...
All PR titles MUST follow Conventional Commit conventions.
...
5. Stage and commit changes:
   - Run `git add -A`
   - Create a **conventional commit** with a clear message describing the changes
6. Push the branch: `git push -u origin <branch>`
7. Create the PR: `gh pr create --title "<conventional-commit-compatible-title>" --body "<commit-message-body>"`
8. Report the PR URL
